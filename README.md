...
- <img src="https://predge.io/favicon.ico" height="14"/> [Predge](https://github.com/predgeAI/whale-data-mcp) - Signed, outcome-verified trader-skill (edge) scores for Polymarket & Kalshi wallets (95% Wilson lower bound over resolved trades, ed25519-signed), paid per call over x402 (USDC on Base).
