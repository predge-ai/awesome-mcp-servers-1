...
- <img src="https://data.predge.io/favicon.ico" height="14"/> [Predge](https://github.com/predgeAI/whale-data-mcp) - Outcome-verified Polymarket whale intelligence for AI agents — trades ≥$10k, wallet leaderboards ranked on realized edge over market price, and smart-money consensus. Pay-per-call USDC on Base via x402, no accounts or API keys.
